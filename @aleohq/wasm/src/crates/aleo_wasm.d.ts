 ...
 * @returns {boolean}
 */
export function verifyFunctionExecution(
  execution: Execution,
...
export class PrivateKey {
   ...
   * @returns {PrivateKey}
   */
  static fromPrivateKeyCiphertext(
...
export class ProgramManager {
  ...
  static buildDeploymentTransaction(
    ...
    url?: string,
    imports?: object,
    fee_proving_key?: ProvingKey,
    fee_verifying_key?: VerifyingKey,
  ...
  static buildJoinTransaction(
    ...
    fee_record?: RecordPlaintext,
    url?: string,
    join_proving_key?: ProvingKey,
    join_verifying_key?: VerifyingKey,
    fee_proving_key?: ProvingKey,
    fee_verifying_key?: VerifyingKey,
    offline_query?: OfflineQuery,
  ): Promise<Transaction>;
  ...
  static buildSplitTransaction(
    ...
    url?: string,
    split_proving_key?: ProvingKey,
    split_verifying_key?: VerifyingKey,
    offline_query?: OfflineQuery,
  ): Promise<Transaction>;
  /**
  ...
  static buildTransferTransaction(
    ...
    amount_record: RecordPlaintext | undefined,
    fee_credits: number,
    fee_record?: RecordPlaintext,
    url?: string,
    transfer_proving_key?: ProvingKey,
    transfer_verifying_key?: VerifyingKey,
    fee_proving_key?: ProvingKey,
    fee_verifying_key?: VerifyingKey,
    offline_query?: OfflineQuery,
  ): Promise<Transaction>;
