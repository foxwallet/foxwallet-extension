  ...
  async getVerifyingKey(verifierUrl: string): Promise<VerifyingKey | Error> {
    switch (verifierUrl) {
      case CREDITS_PROGRAM_KEYS.fee_private.verifier:
        return VerifyingKey.fromString(
          CREDITS_PROGRAM_KEYS.fee_private.verifyingKey,
        );
      case CREDITS_PROGRAM_KEYS.fee_public.verifier:
        return VerifyingKey.fromString(
          CREDITS_PROGRAM_KEYS.fee_public.verifyingKey,
        );
      case CREDITS_PROGRAM_KEYS.inclusion.verifier:
        return VerifyingKey.fromString(
          CREDITS_PROGRAM_KEYS.inclusion.verifyingKey,
        );
      ...
      case CREDITS_PROGRAM_KEYS.transfer_private.verifier:
        return VerifyingKey.fromString(
          CREDITS_PROGRAM_KEYS.transfer_private.verifyingKey,
        );
      case CREDITS_PROGRAM_KEYS.transfer_private_to_public.verifier:
        return VerifyingKey.fromString(
          CREDITS_PROGRAM_KEYS.transfer_private_to_public.verifyingKey,
        );
      case CREDITS_PROGRAM_KEYS.transfer_public.verifier:
        return VerifyingKey.fromString(
          CREDITS_PROGRAM_KEYS.transfer_public.verifyingKey,
        );
      case CREDITS_PROGRAM_KEYS.transfer_public_to_private.verifier:
        return VerifyingKey.fromString(
          CREDITS_PROGRAM_KEYS.transfer_public_to_private.verifyingKey,
        );
      default:
        return <VerifyingKey>(
          VerifyingKey.fromBytes(await this.fetchBytes(verifierUrl))
        );
    }
  }
}
