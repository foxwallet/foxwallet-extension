...
export interface InitOutput {
  ...
  readonly transaction_toBytesLe: (a: number, b: number) => void;
  readonly transaction_constainsSerialNumber: (a: number, b: number) => number;
  readonly transaction_constainsCommitment: (a: number, b: number) => number;
  readonly transaction_findRecord: (a: number, b: number) => number;
  readonly transaction_baseFeeAmount: (a: number) => bigint;
  readonly transaction_feeAmount: (a: number) => bigint;
  readonly transaction_priorityFeeAmount: (a: number) => bigint;
  readonly transaction_isDeploy: (a: number) => number;
  readonly transaction_isExecute: (a: number) => number;
  readonly transaction_isFee: (a: number) => number;
  readonly transaction_deployedProgram: (a: number) => number;
  readonly transaction_execution: (a: number) => number;
  readonly transaction_ownedRecords: (a: number, b: number) => number;
  readonly transaction_records: (a: number) => number;
  ...
  readonly transaction_transitions: (a: number) => number;
  readonly transaction_verifyingKeys: (a: number) => number;
  readonly __wbg_transition_free: (a: number, b: number) => void;
  readonly transition_id: (a: number, b: number) => void;
  readonly transition_fromString: (a: number, b: number, c: number) => void;
  readonly transition_fromBytesLe: (a: number, b: number) => void;
  readonly transition_toString: (a: number, b: number) => void;
  readonly transition_toBytesLe: (a: number, b: number) => void;
  readonly transition_programId: (a: number, b: number) => void;
  readonly transition_functionName: (a: number, b: number) => void;
  readonly transition_containsCommitment: (a: number, b: number) => number;
  readonly transition_containsSerialNumber: (a: number, b: number) => number;
  readonly transition_findRecord: (a: number, b: number) => number;
  readonly transition_ownedRecords: (a: number, b: number) => number;
  ...
  readonly execution_globalStateRoot: (a: number, b: number) => void;
  ...
  readonly recordplaintext_getMember: (a: number, b: number, c: number, d: number) => void;
  ...
  readonly recordplaintext_toJSON: (a: number, b: number) => void;
  ...
  readonly scalar_multiply: (a: number, b: number) => number;
  readonly scalar_divide: (a: number, b: number) => number;
  readonly scalar_double: (a: number) => number;
  readonly scalar_pow: (a: number, b: number) => number;
  readonly scalar_inverse: (a: number) => number;
