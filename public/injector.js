...
var ca = (r, e, t) => e in r ? da(r, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : r[e] = t;
var Ee = (r, e, t) => (ca(r, typeof e != "symbol" ? e + "" : e, t), t), Sn = (r, e, t) => {
  if (!e.has(r))
    throw TypeError("Cannot " + t);
};
var xe = (r, e, t) => (Sn(r, e, "read from private field"), t ? t.call(r) : e.get(r)), _t = (r, e, t) => {
  if (e.has(r))
    throw TypeError("Cannot add the same private member more than once");
  e instanceof WeakSet ? e.add(r) : e.set(r, t);
}, Fe = (r, e, t, a) => (Sn(r, e, "write to private field"), a ? a.call(r, t) : e.set(r, t), t);
const fa = "fox_dapp_request", Ta = "fox_dapp_response", ba = "fox_dapp_emit";
function ha(r) {
  return { all: r = r || /* @__PURE__ */ new Map(), on: function(e, t) {
    ...
    var a = r.get(e);
    a && a.slice().map(function(c) {
      c(t);
    }), (a = r.get("*")) && a.slice().map(function(c) {
      c(e, t);
    });
  } };
}
const ga = "useandom-26T198340PX75pxJACKVERYMINDBUSHWOLF_GQZbfghjklqvwyzrict";
let Ma = (r = 21) => {
...
class Zn {
  ...
  constructor() {
    ...
    Ee(this, "chain");
    Ee(this, "onMessage", (e) => {
      const { id: t, error: a, data: c } = e.detail, y = xe(this, ht).get(t);
      y && (y(a, c), xe(this, ht).delete(t));
    });
    Ee(this, "on", (e, t) => (xe(this, Pe).on(e, t), () => xe(this, Pe).off(e, t)));
    ...
    Fe(this, Ut, !0), Fe(this, Pe, ha()), Fe(this, ht, /* @__PURE__ */ new Map()), this.emit = this.emit.bind(this), window.addEventListener(Ta, this.onMessage), this.onDappEmit = this.onDappEmit.bind(this), window.addEventListener(ba, this.onDappEmit);
  }
  onDappEmit(e) {
  }
  send(e, t, a = {}) {
    return new Promise((c, y) => {
      const T = Ma(), _ = new CustomEvent(
        fa,
        {
          detail: {
            id: T,
      ...
      xe(this, ht).set(T, I), window.dispatchEvent(_);
    });
  }
  get isFoxWallet() {
    return xe(this, Ut);
...
Ut = new WeakMap(), Pe = new WeakMap(), ht = new WeakMap();
function wa(r) {
  return Array.from(r).map((e) => e.toString(16).padStart(2, "0")).join("");
}
var Dt = /* @__PURE__ */ ((r) => (r.ETH = "ETH", r.ALEO = "ALEO", r.QTUM = "QTUM", r))(Dt || {});
Object.values(Dt);
var ze, He;
class _a extends Zn {
  constructor() {
    super();
    Ee(this, "chain", Dt.ALEO);
    _t(this, ze, void 0);
    _t(this, He, void 0);
    Ee(this, "_readyState");
  ...
  async signMessage(t) {
    const a = wa(t), c = await this.send("signMessage", {
      message: a
    });
    if (!c)
      throw new Error("sign message failed");
    return { signature: new TextEncoder().encode(c.signature) };
  }
  send(t, a) {
    return super.send(t, a, {
      address: xe(this, ze),
      network: xe(this, He) ? this.convertNetworkToChainId(xe(this, He)) : ""
    });
  }
}
...
var xn = { exports: {} };
const xa = {}, Ia = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: xa
}, Symbol.toStringTag, { value: "Module" })), Aa = /* @__PURE__ */ va(Ia);
xn.exports;
(function(r) {
  (function(e, t) {
    function a(f, n) {
    ...
    function c(f, n) {
      ...
      s.prototype = n.prototype, f.prototype = new s(), f.prototype.constructor = f;
    }
    function y(f, n, s) {
      if (y.isBN(f))
        return f;
      this.negative = 0, this.words = null, this.length = 0, this.red = null, f !== null && ((n === "le" || n === "be") && (s = n, n = 10), this._init(f || 0, n || 10, s || "be"));
    }
    typeof e == "object" ? e.exports = y : t.BN = y, y.BN = y, y.wordSize = 26;
    var T;
    try {
      typeof window < "u" && typeof window.Buffer < "u" ? T = window.Buffer : T = Aa.Buffer;
    } catch {
    }
    y.isBN = function(n) {
    ...
    function _(f, n) {
      ...
      if (s >= 97 && s <= 102)
        return s - 87;
      a(!1, "Invalid character in " + f);
    }
    function I(f, n, s) {
      var u = _(f, s);
      return s - 1 >= n && (u |= _(f, s - 1) << 4), u;
    }
    y.prototype._parseHex = function(n, s, u) {
      ...
      if (u === "be")
        for (l = n.length - 1; l >= s; l -= 2)
          h = I(n, s, l) << d, this.words[b] |= h & 67108863, d >= 18 ? (d -= 18, b += 1, this.words[b] |= h >>> 26) : d += 8;
      else {
        var o = n.length - s;
    ...
    function E(f, n, s, u) {
      for (var l = 0, d = 0, b = Math.min(f.length, s), h = n; h < b; h++) {
    ...
    function N(f, n) {
      f.words = n.words, f.length = n.length, f.negative = n.negative, f.red = n.red;
    }
    ...
    function Ht(f) {
      for (var n = new Array(f.bitLength()), s = 0; s < n.length; s++) {
        var u = s / 26 | 0, l = s % 26;
        n[s] = f.words[u] >>> l & 1;
      }
      return n;
    ...
    function Mt(f, n, s) {
      s.negative = n.negative ^ f.negative;
      var u = f.length + n.length | 0;
      s.length = u, u = u - 1 | 0;
      var l = f.words[0] | 0, d = n.words[0] | 0, b = l * d, h = b & 67108863, o = b / 67108864 | 0;
      s.words[0] = h;
      for (var i = 1; i < u; i++) {
        for (var m = o >>> 26, C = o & 67108863, p = Math.min(i, n.length - 1), g = Math.max(0, i - f.length + 1); g <= p; g++) {
          var M = i - g | 0;
          l = f.words[M] | 0, d = n.words[g] | 0, b = l * d + C, m += b / 67108864 | 0, C = b & 67108863;
        }
        s.words[i] = C | 0, o = m | 0;
      }
      return o !== 0 ? s.words[i] = o | 0 : s.length--, s._strip();
    }
    var At = function(n, s, u) {
      var l = n.words, d = s.words, b = u.words, h = 0, o, i, m, C = l[0] | 0, p = C & 8191, g = C >>> 13, M = l[1] | 0, w = M & 8191, k = M >>> 13, S = l[2] | 0, x = S & 8191, v = S >>> 13, ge = l[3] | 0, A = ge & 8191, R = ge >>> 13, nt = l[4] | 0, U = nt & 8191, V = nt >>> 13, at = l[5] | 0, z = at & 8191, H = at >>> 13, it = l[6] | 0, q = it & 8191, j = it >>> 13, rt = l[7] | 0, W = rt & 8191, G = rt >>> 13, st = l[8] | 0, K = st & 8191, Z = st >>> 13, pt = l[9] | 0, $ = pt & 8191, Q = pt >>> 13, yt = d[0] | 0, J = yt & 8191, X = yt >>> 13, ut = d[1] | 0, Y = ut & 8191, ee = ut >>> 13, ot = d[2] | 0, te = ot & 8191, ne = ot >>> 13, lt = d[3] | 0, ae = lt & 8191, ie = lt >>> 13, mt = d[4] | 0, re = mt & 8191, se = mt >>> 13, dt = d[5] | 0, pe = dt & 8191, ye = dt >>> 13, ct = d[6] | 0, ue = ct & 8191, oe = ct >>> 13, ft = d[7] | 0, le = ft & 8191, me = ft >>> 13, Tt = d[8] | 0, de = Tt & 8191, ce = Tt >>> 13, bt = d[9] | 0, fe = bt & 8191, Te = bt >>> 13;
      ...
      h = (m + (i >>> 13) | 0) + (Ze >>> 26) | 0, Ze &= 67108863, o = Math.imul(x, J), i = Math.imul(x, X), i = i + Math.imul(v, J) | 0, m = Math.imul(v, X), o = o + Math.imul(w, Y) | 0, i = i + Math.imul(w, ee) | 0, i = i + Math.imul(k, Y) | 0, m = m + Math.imul(k, ee) | 0, o = o + Math.imul(p, te) | 0, i = i + Math.imul(p, ne) | 0, i = i + Math.imul(g, te) | 0, m = m + Math.imul(g, ne) | 0;
      var $e = (h + o | 0) + ((i & 8191) << 13) | 0;
      h = (m + (i >>> 13) | 0) + ($e >>> 26) | 0, $e &= 67108863, o = Math.imul(A, J), i = Math.imul(A, X), i = i + Math.imul(R, J) | 0, m = Math.imul(R, X), o = o + Math.imul(x, Y) | 0, i = i + Math.imul(x, ee) | 0, i = i + Math.imul(v, Y) | 0, m = m + Math.imul(v, ee) | 0, o = o + Math.imul(w, te) | 0, i = i + Math.imul(w, ne) | 0, i = i + Math.imul(k, te) | 0, m = m + Math.imul(k, ne) | 0, o = o + Math.imul(p, ae) | 0, i = i + Math.imul(p, ie) | 0, i = i + Math.imul(g, ae) | 0, m = m + Math.imul(g, ie) | 0;
      var Qe = (h + o | 0) + ((i & 8191) << 13) | 0;
      h = (m + (i >>> 13) | 0) + (Qe >>> 26) | 0, Qe &= 67108863, o = Math.imul(U, J), i = Math.imul(U, X), i = i + Math.imul(V, J) | 0, m = Math.imul(V, X), o = o + Math.imul(A, Y) | 0, i = i + Math.imul(A, ee) | 0, i = i + Math.imul(R, Y) | 0, m = m + Math.imul(R, ee) | 0, o = o + Math.imul(x, te) | 0, i = i + Math.imul(x, ne) | 0, i = i + Math.imul(v, te) | 0, m = m + Math.imul(v, ne) | 0, o = o + Math.imul(w, ae) | 0, i = i + Math.imul(w, ie) | 0, i = i + Math.imul(k, ae) | 0, m = m + Math.imul(k, ie) | 0, o = o + Math.imul(p, re) | 0, i = i + Math.imul(p, se) | 0, i = i + Math.imul(g, re) | 0, m = m + Math.imul(g, se) | 0;
      var Je = (h + o | 0) + ((i & 8191) << 13) | 0;
      h = (m + (i >>> 13) | 0) + (Je >>> 26) | 0, Je &= 67108863, o = Math.imul(z, J), i = Math.imul(z, X), i = i + Math.imul(H, J) | 0, m = Math.imul(H, X), o = o + Math.imul(U, Y) | 0, i = i + Math.imul(U, ee) | 0, i = i + Math.imul(V, Y) | 0, m = m + Math.imul(V, ee) | 0, o = o + Math.imul(A, te) | 0, i = i + Math.imul(A, ne) | 0, i = i + Math.imul(R, te) | 0, m = m + Math.imul(R, ne) | 0, o = o + Math.imul(x, ae) | 0, i = i + Math.imul(x, ie) | 0, i = i + Math.imul(v, ae) | 0, m = m + Math.imul(v, ie) | 0, o = o + Math.imul(w, re) | 0, i = i + Math.imul(w, se) | 0, i = i + Math.imul(k, re) | 0, m = m + Math.imul(k, se) | 0, o = o + Math.imul(p, pe) | 0, i = i + Math.imul(p, ye) | 0, i = i + Math.imul(g, pe) | 0, m = m + Math.imul(g, ye) | 0;
      var an = (h + o | 0) + ((i & 8191) << 13) | 0;
      h = (m + (i >>> 13) | 0) + (an >>> 26) | 0, an &= 67108863, o = Math.imul(q, J), i = Math.imul(q, X), i = i + Math.imul(j, J) | 0, m = Math.imul(j, X), o = o + Math.imul(z, Y) | 0, i = i + Math.imul(z, ee) | 0, i = i + Math.imul(H, Y) | 0, m = m + Math.imul(H, ee) | 0, o = o + Math.imul(U, te) | 0, i = i + Math.imul(U, ne) | 0, i = i + Math.imul(V, te) | 0, m = m + Math.imul(V, ne) | 0, o = o + Math.imul(A, ae) | 0, i = i + Math.imul(A, ie) | 0, i = i + Math.imul(R, ae) | 0, m = m + Math.imul(R, ie) | 0, o = o + Math.imul(x, re) | 0, i = i + Math.imul(x, se) | 0, i = i + Math.imul(v, re) | 0, m = m + Math.imul(v, se) | 0, o = o + Math.imul(w, pe) | 0, i = i + Math.imul(w, ye) | 0, i = i + Math.imul(k, pe) | 0, m = m + Math.imul(k, ye) | 0, o = o + Math.imul(p, ue) | 0, i = i + Math.imul(p, oe) | 0, i = i + Math.imul(g, ue) | 0, m = m + Math.imul(g, oe) | 0;
      var rn = (h + o | 0) + ((i & 8191) << 13) | 0;
      h = (m + (i >>> 13) | 0) + (rn >>> 26) | 0, rn &= 67108863, o = Math.imul(W, J), i = Math.imul(W, X), i = i + Math.imul(G, J) | 0, m = Math.imul(G, X), o = o + Math.imul(q, Y) | 0, i = i + Math.imul(q, ee) | 0, i = i + Math.imul(j, Y) | 0, m = m + Math.imul(j, ee) | 0, o = o + Math.imul(z, te) | 0, i = i + Math.imul(z, ne) | 0, i = i + Math.imul(H, te) | 0, m = m + Math.imul(H, ne) | 0, o = o + Math.imul(U, ae) | 0, i = i + Math.imul(U, ie) | 0, i = i + Math.imul(V, ae) | 0, m = m + Math.imul(V, ie) | 0, o = o + Math.imul(A, re) | 0, i = i + Math.imul(A, se) | 0, i = i + Math.imul(R, re) | 0, m = m + Math.imul(R, se) | 0, o = o + Math.imul(x, pe) | 0, i = i + Math.imul(x, ye) | 0, i = i + Math.imul(v, pe) | 0, m = m + Math.imul(v, ye) | 0, o = o + Math.imul(w, ue) | 0, i = i + Math.imul(w, oe) | 0, i = i + Math.imul(k, ue) | 0, m = m + Math.imul(k, oe) | 0, o = o + Math.imul(p, le) | 0, i = i + Math.imul(p, me) | 0, i = i + Math.imul(g, le) | 0, m = m + Math.imul(g, me) | 0;
      var sn = (h + o | 0) + ((i & 8191) << 13) | 0;
      h = (m + (i >>> 13) | 0) + (sn >>> 26) | 0, sn &= 67108863, o = Math.imul(K, J), i = Math.imul(K, X), i = i + Math.imul(Z, J) | 0, m = Math.imul(Z, X), o = o + Math.imul(W, Y) | 0, i = i + Math.imul(W, ee) | 0, i = i + Math.imul(G, Y) | 0, m = m + Math.imul(G, ee) | 0, o = o + Math.imul(q, te) | 0, i = i + Math.imul(q, ne) | 0, i = i + Math.imul(j, te) | 0, m = m + Math.imul(j, ne) | 0, o = o + Math.imul(z, ae) | 0, i = i + Math.imul(z, ie) | 0, i = i + Math.imul(H, ae) | 0, m = m + Math.imul(H, ie) | 0, o = o + Math.imul(U, re) | 0, i = i + Math.imul(U, se) | 0, i = i + Math.imul(V, re) | 0, m = m + Math.imul(V, se) | 0, o = o + Math.imul(A, pe) | 0, i = i + Math.imul(A, ye) | 0, i = i + Math.imul(R, pe) | 0, m = m + Math.imul(R, ye) | 0, o = o + Math.imul(x, ue) | 0, i = i + Math.imul(x, oe) | 0, i = i + Math.imul(v, ue) | 0, m = m + Math.imul(v, oe) | 0, o = o + Math.imul(w, le) | 0, i = i + Math.imul(w, me) | 0, i = i + Math.imul(k, le) | 0, m = m + Math.imul(k, me) | 0, o = o + Math.imul(p, de) | 0, i = i + Math.imul(p, ce) | 0, i = i + Math.imul(g, de) | 0, m = m + Math.imul(g, ce) | 0;
      var pn = (h + o | 0) + ((i & 8191) << 13) | 0;
      h = (m + (i >>> 13) | 0) + (pn >>> 26) | 0, pn &= 67108863, o = Math.imul($, J), i = Math.imul($, X), i = i + Math.imul(Q, J) | 0, m = Math.imul(Q, X), o = o + Math.imul(K, Y) | 0, i = i + Math.imul(K, ee) | 0, i = i + Math.imul(Z, Y) | 0, m = m + Math.imul(Z, ee) | 0, o = o + Math.imul(W, te) | 0, i = i + Math.imul(W, ne) | 0, i = i + Math.imul(G, te) | 0, m = m + Math.imul(G, ne) | 0, o = o + Math.imul(q, ae) | 0, i = i + Math.imul(q, ie) | 0, i = i + Math.imul(j, ae) | 0, m = m + Math.imul(j, ie) | 0, o = o + Math.imul(z, re) | 0, i = i + Math.imul(z, se) | 0, i = i + Math.imul(H, re) | 0, m = m + Math.imul(H, se) | 0, o = o + Math.imul(U, pe) | 0, i = i + Math.imul(U, ye) | 0, i = i + Math.imul(V, pe) | 0, m = m + Math.imul(V, ye) | 0, o = o + Math.imul(A, ue) | 0, i = i + Math.imul(A, oe) | 0, i = i + Math.imul(R, ue) | 0, m = m + Math.imul(R, oe) | 0, o = o + Math.imul(x, le) | 0, i = i + Math.imul(x, me) | 0, i = i + Math.imul(v, le) | 0, m = m + Math.imul(v, me) | 0, o = o + Math.imul(w, de) | 0, i = i + Math.imul(w, ce) | 0, i = i + Math.imul(k, de) | 0, m = m + Math.imul(k, ce) | 0, o = o + Math.imul(p, fe) | 0, i = i + Math.imul(p, Te) | 0, i = i + Math.imul(g, fe) | 0, m = m + Math.imul(g, Te) | 0;
      var yn = (h + o | 0) + ((i & 8191) << 13) | 0;
      h = (m + (i >>> 13) | 0) + (yn >>> 26) | 0, yn &= 67108863, o = Math.imul($, Y), i = Math.imul($, ee), i = i + Math.imul(Q, Y) | 0, m = Math.imul(Q, ee), o = o + Math.imul(K, te) | 0, i = i + Math.imul(K, ne) | 0, i = i + Math.imul(Z, te) | 0, m = m + Math.imul(Z, ne) | 0, o = o + Math.imul(W, ae) | 0, i = i + Math.imul(W, ie) | 0, i = i + Math.imul(G, ae) | 0, m = m + Math.imul(G, ie) | 0, o = o + Math.imul(q, re) | 0, i = i + Math.imul(q, se) | 0, i = i + Math.imul(j, re) | 0, m = m + Math.imul(j, se) | 0, o = o + Math.imul(z, pe) | 0, i = i + Math.imul(z, ye) | 0, i = i + Math.imul(H, pe) | 0, m = m + Math.imul(H, ye) | 0, o = o + Math.imul(U, ue) | 0, i = i + Math.imul(U, oe) | 0, i = i + Math.imul(V, ue) | 0, m = m + Math.imul(V, oe) | 0, o = o + Math.imul(A, le) | 0, i = i + Math.imul(A, me) | 0, i = i + Math.imul(R, le) | 0, m = m + Math.imul(R, me) | 0, o = o + Math.imul(x, de) | 0, i = i + Math.imul(x, ce) | 0, i = i + Math.imul(v, de) | 0, m = m + Math.imul(v, ce) | 0, o = o + Math.imul(w, fe) | 0, i = i + Math.imul(w, Te) | 0, i = i + Math.imul(k, fe) | 0, m = m + Math.imul(k, Te) | 0;
      var un = (h + o | 0) + ((i & 8191) << 13) | 0;
      h = (m + (i >>> 13) | 0) + (un >>> 26) | 0, un &= 67108863, o = Math.imul($, te), i = Math.imul($, ne), i = i + Math.imul(Q, te) | 0, m = Math.imul(Q, ne), o = o + Math.imul(K, ae) | 0, i = i + Math.imul(K, ie) | 0, i = i + Math.imul(Z, ae) | 0, m = m + Math.imul(Z, ie) | 0, o = o + Math.imul(W, re) | 0, i = i + Math.imul(W, se) | 0, i = i + Math.imul(G, re) | 0, m = m + Math.imul(G, se) | 0, o = o + Math.imul(q, pe) | 0, i = i + Math.imul(q, ye) | 0, i = i + Math.imul(j, pe) | 0, m = m + Math.imul(j, ye) | 0, o = o + Math.imul(z, ue) | 0, i = i + Math.imul(z, oe) | 0, i = i + Math.imul(H, ue) | 0, m = m + Math.imul(H, oe) | 0, o = o + Math.imul(U, le) | 0, i = i + Math.imul(U, me) | 0, i = i + Math.imul(V, le) | 0, m = m + Math.imul(V, me) | 0, o = o + Math.imul(A, de) | 0, i = i + Math.imul(A, ce) | 0, i = i + Math.imul(R, de) | 0, m = m + Math.imul(R, ce) | 0, o = o + Math.imul(x, fe) | 0, i = i + Math.imul(x, Te) | 0, i = i + Math.imul(v, fe) | 0, m = m + Math.imul(v, Te) | 0;
      var on = (h + o | 0) + ((i & 8191) << 13) | 0;
      h = (m + (i >>> 13) | 0) + (on >>> 26) | 0, on &= 67108863, o = Math.imul($, ae), i = Math.imul($, ie), i = i + Math.imul(Q, ae) | 0, m = Math.imul(Q, ie), o = o + Math.imul(K, re) | 0, i = i + Math.imul(K, se) | 0, i = i + Math.imul(Z, re) | 0, m = m + Math.imul(Z, se) | 0, o = o + Math.imul(W, pe) | 0, i = i + Math.imul(W, ye) | 0, i = i + Math.imul(G, pe) | 0, m = m + Math.imul(G, ye) | 0, o = o + Math.imul(q, ue) | 0, i = i + Math.imul(q, oe) | 0, i = i + Math.imul(j, ue) | 0, m = m + Math.imul(j, oe) | 0, o = o + Math.imul(z, le) | 0, i = i + Math.imul(z, me) | 0, i = i + Math.imul(H, le) | 0, m = m + Math.imul(H, me) | 0, o = o + Math.imul(U, de) | 0, i = i + Math.imul(U, ce) | 0, i = i + Math.imul(V, de) | 0, m = m + Math.imul(V, ce) | 0, o = o + Math.imul(A, fe) | 0, i = i + Math.imul(A, Te) | 0, i = i + Math.imul(R, fe) | 0, m = m + Math.imul(R, Te) | 0;
      var ln = (h + o | 0) + ((i & 8191) << 13) | 0;
      h = (m + (i >>> 13) | 0) + (ln >>> 26) | 0, ln &= 67108863, o = Math.imul($, re), i = Math.imul($, se), i = i + Math.imul(Q, re) | 0, m = Math.imul(Q, se), o = o + Math.imul(K, pe) | 0, i = i + Math.imul(K, ye) | 0, i = i + Math.imul(Z, pe) | 0, m = m + Math.imul(Z, ye) | 0, o = o + Math.imul(W, ue) | 0, i = i + Math.imul(W, oe) | 0, i = i + Math.imul(G, ue) | 0, m = m + Math.imul(G, oe) | 0, o = o + Math.imul(q, le) | 0, i = i + Math.imul(q, me) | 0, i = i + Math.imul(j, le) | 0, m = m + Math.imul(j, me) | 0, o = o + Math.imul(z, de) | 0, i = i + Math.imul(z, ce) | 0, i = i + Math.imul(H, de) | 0, m = m + Math.imul(H, ce) | 0, o = o + Math.imul(U, fe) | 0, i = i + Math.imul(U, Te) | 0, i = i + Math.imul(V, fe) | 0, m = m + Math.imul(V, Te) | 0;
      var mn = (h + o | 0) + ((i & 8191) << 13) | 0;
      h = (m + (i >>> 13) | 0) + (mn >>> 26) | 0, mn &= 67108863, o = Math.imul($, pe), i = Math.imul($, ye), i = i + Math.imul(Q, pe) | 0, m = Math.imul(Q, ye), o = o + Math.imul(K, ue) | 0, i = i + Math.imul(K, oe) | 0, i = i + Math.imul(Z, ue) | 0, m = m + Math.imul(Z, oe) | 0, o = o + Math.imul(W, le) | 0, i = i + Math.imul(W, me) | 0, i = i + Math.imul(G, le) | 0, m = m + Math.imul(G, me) | 0, o = o + Math.imul(q, de) | 0, i = i + Math.imul(q, ce) | 0, i = i + Math.imul(j, de) | 0, m = m + Math.imul(j, ce) | 0, o = o + Math.imul(z, fe) | 0, i = i + Math.imul(z, Te) | 0, i = i + Math.imul(H, fe) | 0, m = m + Math.imul(H, Te) | 0;
      var dn = (h + o | 0) + ((i & 8191) << 13) | 0;
      h = (m + (i >>> 13) | 0) + (dn >>> 26) | 0, dn &= 67108863, o = Math.imul($, ue), i = Math.imul($, oe), i = i + Math.imul(Q, ue) | 0, m = Math.imul(Q, oe), o = o + Math.imul(K, le) | 0, i = i + Math.imul(K, me) | 0, i = i + Math.imul(Z, le) | 0, m = m + Math.imul(Z, me) | 0, o = o + Math.imul(W, de) | 0, i = i + Math.imul(W, ce) | 0, i = i + Math.imul(G, de) | 0, m = m + Math.imul(G, ce) | 0, o = o + Math.imul(q, fe) | 0, i = i + Math.imul(q, Te) | 0, i = i + Math.imul(j, fe) | 0, m = m + Math.imul(j, Te) | 0;
      ...
      return h = (m + (i >>> 13) | 0) + (bn >>> 26) | 0, bn &= 67108863, b[0] = Ke, b[1] = Ze, b[2] = $e, b[3] = Qe, b[4] = Je, b[5] = an, b[6] = rn, b[7] = sn, b[8] = pn, b[9] = yn, b[10] = un, b[11] = on, b[12] = ln, b[13] = mn, b[14] = dn, b[15] = cn, b[16] = fn, b[17] = Tn, b[18] = bn, h !== 0 && (b[19] = h, u.length++), u;
    };
    Math.imul || (At = Mt);
    function Et(f, n, s) {
      s.negative = n.negative ^ f.negative, s.length = f.length + n.length;
      for (var u = 0, l = 0, d = 0; d < s.length - 1; d++) {
        var b = l;
        l = 0;
        for (var h = u & 67108863, o = Math.min(d, n.length - 1), i = Math.max(0, d - f.length + 1); i <= o; i++) {
          var m = d - i, C = f.words[m] | 0, p = n.words[i] | 0, g = C * p, M = g & 67108863;
    ...
    y.prototype.mulTo = function(n, s) {
      ...
      return this.length === 10 && n.length === 10 ? u = At(this, n, s) : l < 63 ? u = Mt(this, n, s) : l < 1024 ? u = Et(this, n, s) : u = St(this, n, s), u;
    }, y.prototype.mul = function(n) {
      var s = new y(null);
      return s.words = new Array(this.length + n.length), this.mulTo(n, s);
    }, y.prototype.mulf = function(n) {
      var s = new y(null);
      return s.words = new Array(this.length + n.length), St(this, n, s);
    ...
    function Ae(f, n) {
      this.name = f, this.p = new y(n, 16), this.n = this.p.bitLength(), this.k = new y(1).iushln(this.n).isub(this.p), this.tmp = this._tmp();
    }
    ...
    c(et, Ae), et.prototype.split = function(n, s) {
    ...
    c(Ot, Ae), Ot.prototype.imulK = function(n) {
      for (var s = 0, u = 0; u < n.length; u++) {
    ...
    c(Ue, he), Ue.prototype.convertTo = function(n) {
...
var Ea = xn.exports;
const Sa = /* @__PURE__ */ Qn(Ea), Ca = "logger/5.7.0";
let Cn = !1, On = !1;
const $t = { debug: 1, default: 2, info: 2, warning: 3, error: 4, off: 5 };
let Rn = $t.default, hn = null;
function Oa() {
  try {
    const r = [];
...
class O {
  ...
  _log(e, t) {
    ...
    $t[a] == null && this.throwArgumentError("invalid log level name", "logLevel", e), !(Rn > $t[a]) && console.log.apply(console, t);
  }
  debug(...e) {
  ...
  makeError(e, t, a) {
      ...
      try {
        if (E instanceof Uint8Array) {
          ...
          for (let B = 0; B < E.length; B++)
            N += Dn[E[B] >> 4], N += Dn[E[B] & 15];
          c.push(I + "=Uint8Array(0x" + N + ")");
        } else
          c.push(I + "=" + JSON.stringify(E));
      } catch {
        c.push(I + "=" + JSON.stringify(a[I].toString()));
      }
    ...
    T && (e += " [ See: https://links.ethers.org/v5-errors-" + T + " ]"), c.length && (e += " (" + c.join(", ") + ")");
    const _ = new Error(e);
    return _.reason = y, _.code = t, Object.keys(a).forEach(function(I) {
      _[I] = a[I];
    }), _;
  }
  throwError(e, t, a) {
  ...
  assert(e, t, a, c) {
    e || this.throwError(t, a, c);
  }
  assertArgument(e, t, a, c) {
    e || this.throwArgumentError(t, a, c);
  }
  checkNormalize(e) {
    Nn && this.throwError("platform missing String.prototype.normalize", O.errors.UNSUPPORTED_OPERATION, {
...
O.errors = Ne;
O.levels = wn;
const Ra = "bytes/5.7.0", We = new O(Ra);
function Jn(r) {
...
function Nt(r) {
  return r.slice || (r.slice = function() {
    ...
    return Nt(new Uint8Array(Array.prototype.slice.apply(r, e)));
  }), r;
}
function Fn(r) {
...
function In(r) {
  ...
  if (r.constructor === Uint8Array)
    return !0;
  if (typeof r == "string" || !Fn(r.length) || r.length < 0)
    return !1;
...
function Ce(r, e) {
  if (e || (e = {}), typeof r == "number") {
    ...
    return t.length === 0 && t.push(0), Nt(new Uint8Array(t));
  }
  if (e.allowMissingPrefix && typeof r == "string" && r.substring(0, 2) !== "0x" && (r = "0x" + r), Jn(r) && (r = r.toHexString()), De(r)) {
    let t = r.substring(2);
    ...
    for (let c = 0; c < t.length; c += 2)
      a.push(parseInt(t.substring(c, c + 2), 16));
    return Nt(new Uint8Array(a));
  }
  return In(r) ? Nt(new Uint8Array(r)) : We.throwArgumentError("invalid arrayify value", "value", r);
}
function xt(r) {
  const e = r.map((c) => Ce(c)), t = e.reduce((c, y) => c + y.length, 0), a = new Uint8Array(t);
  return e.reduce((c, y) => (a.set(y, c), c + y.length), 0), Nt(a);
}
function De(r, e) {
...
function _e(r, e) {
  if (e || (e = {}), typeof r == "number") {
    ...
    let t = "";
    for (; r; )
      t = gn[r & 15] + t, r = Math.floor(r / 16);
    return t.length ? (t.length % 2 && (t = "0" + t), "0x" + t) : "0x00";
  }
  if (typeof r == "bigint")
    return r = r.toString(16), r.length % 2 ? "0x0" + r : "0x" + r;
  if (e.allowMissingPrefix && typeof r == "string" && r.substring(0, 2) !== "0x" && (r = "0x" + r), Jn(r))
    return r.toHexString();
  if (De(r))
...
const Fa = "bignumber/5.7.0";
var Jt = Sa.BN;
const Ve = new O(Fa), Mn = {}, Pn = 9007199254740991;
let Ln = !1;
class be {
  constructor(e, t) {
  ...
  toString() {
    return arguments.length > 0 && (arguments[0] === 10 ? Ln || (Ln = !0, Ve.warn("BigNumber.toString does not accept any parameters; base-10 is assumed")) : arguments[0] === 16 ? Ve.throwError("BigNumber.toString does not accept any parameters; use bigNumber.toHexString()", O.errors.UNEXPECTED_ARGUMENT, {}) : Ve.throwError("BigNumber.toString does not accept parameters", O.errors.UNEXPECTED_ARGUMENT, {})), D(this).toString(10);
  }
  toHexString() {
    return this._hex;
  }
  ...
  static from(e) {
    if (e instanceof be)
      return e;
    if (typeof e == "string")
      return e.match(/^-?0x[0-9a-f]+$/i) ? new be(Mn, Ft(e)) : e.match(/^-?[0-9]+$/) ? new be(Mn, Ft(new Jt(e))) : Ve.throwArgumentError("invalid BigNumber string", "value", e);
    if (typeof e == "number")
      return e % 1 && Re("underflow", "BigNumber.from", e), (e >= Pn || e <= -Pn) && Re("overflow", "BigNumber.from", e), be.from(String(e));
    const t = e;
    if (typeof t == "bigint")
...
function Ft(r) {
  if (typeof r != "string")
    return Ft(r.toString(16));
  if (r[0] === "-")
    return r = r.substring(1), r[0] === "-" && Ve.throwArgumentError("invalid hex", "value", r), r = Ft(r), r === "0x00" ? r : "-" + r;
...
function D(r) {
  ...
  return e[0] === "-" ? new Jt("-" + e.substring(3), 16) : new Jt(e.substring(2), 16);
}
function Re(r, e, t) {
...
function Pa(r) {
  return new Jt(r, 36).toString(16);
}
const La = "properties/5.7.0";
...
const Ba = { bigint: !0, boolean: !0, function: !0, number: !0, string: !0 };
function ea(r) {
  if (r == null || Ba[typeof r])
    return !0;
  ...
  return Yn.throwArgumentError(`Cannot deepCopy ${typeof r}`, "object", r);
}
function Ua(r) {
  if (ea(r))
    return r;
  if (Array.isArray(r))
    return Object.freeze(r.map((e) => _n(e)));
  if (typeof r == "object") {
    const e = {};
    for (const t in r) {
      const a = r[t];
      a !== void 0 && Ie(e, t, _n(a));
    }
    return e;
  }
  return Yn.throwArgumentError(`Cannot deepCopy ${typeof r}`, "object", r);
...
const Vt = "abi/5.7.0", F = new O(Vt), gt = {};
let Bn = { calldata: !0, memory: !0, storage: !0 }, Va = { calldata: !0, memory: !0 };
function jt(r, e) {
  if (r === "bytes" || r === "string") {
    if (Bn[e])
      return !0;
    ...
    if (e === "payable")
      return !0;
  } else if ((r.indexOf("[") >= 0 || r === "tuple") && Va[e])
    return !0;
  return (Bn[e] || e === "payable") && F.throwArgumentError("invalid modifier", "name", e), !1;
}
function za(r, e) {
  let t = r;
  function a(_) {
  ...
  r = r.replace(/\s/g, " ");
  function c(_) {
    let I = { type: "", name: "", parent: _, state: { allowType: !0 } };
    return e && (I.indexed = !1), I;
  }
  ...
  for (let _ = 0; _ < r.length; _++) {
    ...
    switch (I) {
      case "(":
        T.state.allowType && T.type === "" ? T.type = "tuple" : T.state.allowParams || a(_), T.state.allowType = !1, T.type = kt(T.type), T.components = [c(T)], T = T.components[0];
        break;
      case ")":
        delete T.state, T.name === "indexed" && (e || a(_), T.indexed = !0, T.name = ""), jt(T.type, T.name) && (T.name = ""), T.type = kt(T.type);
        let E = T;
      ...
      case ",":
        ...
        break;
      case " ":
        T.state.allowType && T.type !== "" && (T.type = kt(T.type), delete T.state.allowType, T.state.allowName = !0, T.state.allowParams = !0), T.state.allowName && T.name !== "" && (T.name === "indexed" ? (e || a(_), T.indexed && a(_), T.indexed = !0, T.name = "") : jt(T.type, T.name) ? T.name = "" : T.state.allowName = !1);
        break;
      case "[":
        T.state.allowArray || a(_), T.type += I, T.state.allowArray = !1, T.state.allowName = !1, T.state.readArray = !0;
        break;
      case "]":
        T.state.readArray || a(_), T.type += I, T.state.readArray = !1, T.state.allowArray = !0, T.state.allowName = !0;
        break;
      default:
        T.state.allowType ? (T.type += I, T.state.allowParams = !0, T.state.allowArray = !0) : T.state.allowName ? (T.name += I, delete T.state.allowArray) : T.state.readArray ? T.type += I : a(_);
    }
  }
  return T.parent && F.throwArgumentError("unexpected eof", "param", r), delete y.state, T.name === "indexed" ? (e || a(t.length - 7), T.indexed && a(t.length - 7), T.indexed = !0, T.name = "") : jt(T.type, T.name) && (T.name = ""), y.type = kt(y.type), y;
}
function Qt(r, e) {
  for (let t in e)
    Ie(r, t, e[t]);
...
class ve {
  ...
  static fromObject(e) {
    return ve.isParamType(e) ? e : new ve(gt, {
      name: e.name || null,
      type: kt(e.type),
...
function Pt(r, e) {
  return ja(r).map((t) => ve.fromString(t, e));
}
class je {
  constructor(e, t) {
    e !== gt && F.throwError("use a static from method", O.errors.UNSUPPORTED_OPERATION, {
      operation: "new Fragment()"
    }), Qt(this, t), this._isFragment = !0, Object.freeze(this);
  }
  static from(e) {
...
class Le extends je {
  ...
  static fromString(e) {
    ...
    e = ta(e, t);
    let a = e.match(Bt);
    return (!a || a[1].trim() !== "constructor") && F.throwArgumentError("invalid constructor string", "value", e), t.inputs = Pt(a[2].trim(), !1), na(a[3].trim(), t), Le.fromObject(t);
  }
...
class Be extends Le {
  ...
  static fromString(e) {
    ...
    let c = a[0].match(Bt);
    if (c || F.throwArgumentError("invalid function signature", "value", e), t.name = c[1].trim(), t.name && Lt(t.name), t.inputs = Pt(c[2], !1), na(c[3].trim(), t), a.length > 1) {
      let y = a[1].match(Bt);
      (y[1].trim() != "" || y[3].trim() != "") && F.throwArgumentError("unexpected tokens", "value", e), t.outputs = Pt(y[2], !1);
    } else
      t.outputs = [];
...
class Xe extends je {
  ...
  static fromObject(e) {
    ...
    return Un(new Xe(gt, t));
  }
  static fromString(e) {
    let t = { type: "error" }, a = e.match(Bt);
    return a || F.throwArgumentError("invalid error signature", "value", e), t.name = a[1].trim(), t.name && Lt(t.name), t.inputs = Pt(a[2], !1), Un(Xe.fromObject(t));
  }
...
const qa = new RegExp("^[a-zA-Z$_][a-zA-Z0-9$_]*$");
function Lt(r) {
  return (!r || !r.match(qa)) && F.throwArgumentError(`invalid identifier "${r}"`, "value", r), r;
}
const Bt = new RegExp("^([^)(]*)\\((.*)\\)([^)(]*)$");
function ja(r) {
  r = r.trim();
...
class Ge {
  constructor(e, t, a, c) {
    this.name = e, this.type = t, this.localName = a, this.dynamic = c;
  }
  _throwError(e, t) {
...
class kn {
  ...
  appendWriter(e) {
    return this._writeData(xt(e._data));
  }
  // Arrayish items; padded on the right to wordSize
  writeBytes(e) {
    let t = Ce(e);
    const a = t.length % this.wordSize;
    return a && (t = xt([t, this._padding.slice(a)])), this._writeData(t);
  }
  _getValue(e) {
    let t = Ce(be.from(e));
    return t.length > this.wordSize && An.throwError("value out-of-bounds", O.errors.BUFFER_OVERRUN, {
      ...
      offset: t.length
    }), t.length % this.wordSize && (t = xt([this._padding.slice(t.length % this.wordSize), t])), t;
  }
...
class Xt {
  constructor(e, t, a, c) {
    Ie(this, "_data", Ce(e)), Ie(this, "wordSize", t || 32), Ie(this, "_coerceFunc", a), Ie(this, "allowLoose", c), this._offset = 0;
  }
  get data() {
  ...
  coerce(e, t) {
    return this._coerceFunc ? this._coerceFunc(e, t) : Xt.coerce(e, t);
  }
  _peekBytes(e, t, a) {
    let c = Math.ceil(t / this.wordSize) * this.wordSize;
    return this._offset + c > this._data.length && (this.allowLoose && a && this._offset + t <= this._data.length ? c = t : An.throwError("data out-of-bounds", O.errors.BUFFER_OVERRUN, {
      length: this._data.length,
      offset: this._offset + c
    })), this._data.slice(this._offset, this._offset + c);
  }
  subReader(e) {
    return new Xt(this._data.slice(this._offset + e), this.wordSize, this._coerceFunc, this.allowLoose);
  }
  readBytes(e, t) {
...
(function(r) {
  (function() {
    var e = "input is invalid type", t = "finalize already called", a = typeof window == "object", c = a ? window : {};
    c.JS_SHA3_NO_WINDOW && (a = !1);
    var y = !a && typeof self == "object", T = !c.JS_SHA3_NO_NODE_JS && typeof process == "object" && process.versions && process.versions.node;
    T ? c = $n : y && (c = self);
    var _ = !c.JS_SHA3_NO_COMMON_JS && !0 && r.exports, I = !c.JS_SHA3_NO_ARRAY_BUFFER && typeof ArrayBuffer < "u", E = "0123456789abcdef".split(""), N = [31, 7936, 2031616, 520093696], B = [4, 1024, 262144, 67108864], L = [1, 256, 65536, 16777216], ke = [6, 1536, 393216, 100663296], we = [0, 8, 16, 24], zt = [
      1,
      0,
      32898,
      0,
      ...
      2147516424,
      2147483648
    ], Ht = [224, 256, 384, 512], Mt = [128, 256], At = ["hex", "buffer", "arrayBuffer", "array", "digest"], Et = {
      128: 168,
      256: 136
    };
    (c.JS_SHA3_NO_NODE_JS || !Array.isArray) && (Array.isArray = function(p) {
      return Object.prototype.toString.call(p) === "[object Array]";
    }), I && (c.JS_SHA3_NO_ARRAY_BUFFER_IS_VIEW || !ArrayBuffer.isView) && (ArrayBuffer.isView = function(p) {
      return typeof p == "object" && p.buffer && p.buffer.constructor === ArrayBuffer;
    });
    for (var St = function(p, g, M) {
      return function(w) {
      ...
      return function(w, k, S, x) {
        return n["cshake" + p].update(w, k, S, x)[M]();
      };
    }, et = function(p, g, M) {
      return function(w, k, S, x) {
        return n["kmac" + p].update(w, k, S, x)[M]();
      };
    }, tt = function(p, g, M, w) {
      ...
      var M = Et[p], w = Ae(p, g, "hex");
      return w.create = function(k, S, x) {
        return !S && !x ? n["shake" + p].create(k) : new i(p, g, k).bytepad([S, x], M);
      }, w.update = function(k, S, x, v) {
        return w.create(S, x, v).update(k);
      }, tt(w, Ae, p, g);
    }, Ue = function(p, g) {
      var M = Et[p], w = et(p, g, "hex");
      return w.create = function(k, S, x) {
        return new m(p, g, S).bytepad(["KMAC", x], M).bytepad([k], M);
      }, w.update = function(k, S, x, v) {
        return w.create(k, x, v).update(S);
      }, tt(w, et, p, g);
    }, f = [
      { name: "keccak", padding: L, bits: Ht, createMethod: Ct },
      { name: "sha3", padding: ke, bits: Ht, createMethod: Ct },
      { name: "shake", padding: N, bits: Mt, createMethod: Ot },
      { name: "cshake", padding: B, bits: Mt, createMethod: he },
      { name: "kmac", padding: B, bits: Mt, createMethod: Ue }
    ], n = {}, s = [], u = 0; u < f.length; ++u)
      for (var l = f[u], d = l.bits, b = 0; b < d.length; ++b) {
        var h = l.name + "_" + d[b];
    ...
    i.prototype.update = function(p) {
      ...
      if (M !== "string") {
        if (M === "object") {
          if (p === null)
            throw new Error(e);
          if (I && p.constructor === ArrayBuffer)
            p = new Uint8Array(p);
          else if (!Array.isArray(p) && (!I || !ArrayBuffer.isView(p)))
            throw new Error(e);
        } else
          throw new Error(e);
        g = !0;
      }
      for (var w = this.blocks, k = this.byteCount, S = p.length, x = this.blockCount, v = 0, ge = this.s, A, R; v < S; ) {
        if (this.reset)
          for (this.reset = !1, w[0] = this.block, A = 1; A < x + 1; ++A)
            w[A] = 0;
        if (g)
        ...
        if (this.lastByteIndex = A, A >= k) {
          for (this.start = A - k, this.block = w[x], A = 0; A < x; ++A)
            ge[A] ^= w[A];
          C(ge), this.reset = !0;
        } else
          this.start = A;
      ...
      if (g)
        ...
        for (var S = 0; S < p.length; ++S) {
          ...
          x < 128 ? w += 1 : x < 2048 ? w += 2 : x < 55296 || x >= 57344 ? w += 3 : (x = 65536 + ((x & 1023) << 10 | p.charCodeAt(++S) & 1023), w += 4);
        }
      ...
      this.finalize();
      for (var p = this.blockCount, g = this.s, M = this.outputBlocks, w = this.extraBytes, k = 0, S = 0, x = "", v; S < M; ) {
        for (k = 0; k < p && S < M; ++k, ++S)
          v = g[k], x += E[v >> 4 & 15] + E[v & 15] + E[v >> 12 & 15] + E[v >> 8 & 15] + E[v >> 20 & 15] + E[v >> 16 & 15] + E[v >> 28 & 15] + E[v >> 24 & 15];
        S % p === 0 && (C(g), k = 0);
      }
      return w && (v = g[k], x += E[v >> 4 & 15] + E[v & 15], w > 1 && (x += E[v >> 12 & 15] + E[v >> 8 & 15]), w > 2 && (x += E[v >> 20 & 15] + E[v >> 16 & 15])), x;
    }, i.prototype.arrayBuffer = function() {
      this.finalize();
      var p = this.blockCount, g = this.s, M = this.outputBlocks, w = this.extraBytes, k = 0, S = 0, x = this.outputBits >> 3, v;
      w ? v = new ArrayBuffer(M + 1 << 2) : v = new ArrayBuffer(x);
      for (var ge = new Uint32Array(v); S < M; ) {
        for (k = 0; k < p && S < M; ++k, ++S)
          ge[S] = g[k];
        S % p === 0 && C(g);
      }
      return w && (ge[k] = g[k], v = v.slice(0, x)), v;
    }, i.prototype.buffer = i.prototype.arrayBuffer, i.prototype.digest = i.prototype.array = function() {
      this.finalize();
      for (var p = this.blockCount, g = this.s, M = this.outputBlocks, w = this.extraBytes, k = 0, S = 0, x = [], v, ge; S < M; ) {
        for (k = 0; k < p && S < M; ++k, ++S)
          v = S << 2, ge = g[k], x[v] = ge & 255, x[v + 1] = ge >> 8 & 255, x[v + 2] = ge >> 16 & 255, x[v + 3] = ge >> 24 & 255;
        S % p === 0 && C(g);
      }
      return w && (v = S << 2, ge = g[k], x[v] = ge & 255, w > 1 && (x[v + 1] = ge >> 8 & 255), w > 2 && (x[v + 2] = ge >> 16 & 255)), x;
    };
    function m(p, g, M) {
      i.call(this, p, g, M);
    }
    ...
    var C = function(p) {
      var g, M, w, k, S, x, v, ge, A, R, nt, U, V, at, z, H, it, q, j, rt, W, G, st, K, Z, pt, $, Q, yt, J, X, ut, Y, ee, ot, te, ne, lt, ae, ie, mt, re, se, dt, pe, ye, ct, ue, oe, ft, le, me, Tt, de, ce, bt, fe, Te, Ke, Ze, $e, Qe, Je;
      for (w = 0; w < 48; w += 2)
        k = p[0] ^ p[10] ^ p[20] ^ p[30] ^ p[40], S = p[1] ^ p[11] ^ p[21] ^ p[31] ^ p[41], x = p[2] ^ p[12] ^ p[22] ^ p[32] ^ p[42], v = p[3] ^ p[13] ^ p[23] ^ p[33] ^ p[43], ge = p[4] ^ p[14] ^ p[24] ^ p[34] ^ p[44], A = p[5] ^ p[15] ^ p[25] ^ p[35] ^ p[45], R = p[6] ^ p[16] ^ p[26] ^ p[36] ^ p[46], nt = p[7] ^ p[17] ^ p[27] ^ p[37] ^ p[47], U = p[8] ^ p[18] ^ p[28] ^ p[38] ^ p[48], V = p[9] ^ p[19] ^ p[29] ^ p[39] ^ p[49], g = U ^ (x << 1 | v >>> 31), M = V ^ (v << 1 | x >>> 31), p[0] ^= g, p[1] ^= M, p[10] ^= g, p[11] ^= M, p[20] ^= g, p[21] ^= M, p[30] ^= g, p[31] ^= M, p[40] ^= g, p[41] ^= M, g = k ^ (ge << 1 | A >>> 31), M = S ^ (A << 1 | ge >>> 31), p[2] ^= g, p[3] ^= M, p[12] ^= g, p[13] ^= M, p[22] ^= g, p[23] ^= M, p[32] ^= g, p[33] ^= M, p[42] ^= g, p[43] ^= M, g = x ^ (R << 1 | nt >>> 31), M = v ^ (nt << 1 | R >>> 31), p[4] ^= g, p[5] ^= M, p[14] ^= g, p[15] ^= M, p[24] ^= g, p[25] ^= M, p[34] ^= g, p[35] ^= M, p[44] ^= g, p[45] ^= M, g = ge ^ (U << 1 | V >>> 31), M = A ^ (V << 1 | U >>> 31), p[6] ^= g, p[7] ^= M, p[16] ^= g, p[17] ^= M, p[26] ^= g, p[27] ^= M, p[36] ^= g, p[37] ^= M, p[46] ^= g, p[47] ^= M, g = R ^ (k << 1 | S >>> 31), M = nt ^ (S << 1 | k >>> 31), p[8] ^= g, p[9] ^= M, p[18] ^= g, p[19] ^= M, p[28] ^= g, p[29] ^= M, p[38] ^= g, p[39] ^= M, p[48] ^= g, p[49] ^= M, at = p[0], z = p[1], ye = p[11] << 4 | p[10] >>> 28, ct = p[10] << 4 | p[11] >>> 28, Q = p[20] << 3 | p[21] >>> 29, yt = p[21] << 3 | p[20] >>> 29, Ze = p[31] << 9 | p[30] >>> 23, $e = p[30] << 9 | p[31] >>> 23, re = p[40] << 18 | p[41] >>> 14, se = p[41] << 18 | p[40] >>> 14, ee = p[2] << 1 | p[3] >>> 31, ot = p[3] << 1 | p[2] >>> 31, H = p[13] << 12 | p[12] >>> 20, it = p[12] << 12 | p[13] >>> 20, ue = p[22] << 10 | p[23] >>> 22, oe = p[23] << 10 | p[22] >>> 22, J = p[33] << 13 | p[32] >>> 19, X = p[32] << 13 | p[33] >>> 19, Qe = p[42] << 2 | p[43] >>> 30, Je = p[43] << 2 | p[42] >>> 30, de = p[5] << 30 | p[4] >>> 2, ce = p[4] << 30 | p[5] >>> 2, te = p[14] << 6 | p[15] >>> 26, ne = p[15] << 6 | p[14] >>> 26, q = p[25] << 11 | p[24] >>> 21, j = p[24] << 11 | p[25] >>> 21, ft = p[34] << 15 | p[35] >>> 17, le = p[35] << 15 | p[34] >>> 17, ut = p[45] << 29 | p[44] >>> 3, Y = p[44] << 29 | p[45] >>> 3, K = p[6] << 28 | p[7] >>> 4, Z = p[7] << 28 | p[6] >>> 4, bt = p[17] << 23 | p[16] >>> 9, fe = p[16] << 23 | p[17] >>> 9, lt = p[26] << 25 | p[27] >>> 7, ae = p[27] << 25 | p[26] >>> 7, rt = p[36] << 21 | p[37] >>> 11, W = p[37] << 21 | p[36] >>> 11, me = p[47] << 24 | p[46] >>> 8, Tt = p[46] << 24 | p[47] >>> 8, dt = p[8] << 27 | p[9] >>> 5, pe = p[9] << 27 | p[8] >>> 5, pt = p[18] << 20 | p[19] >>> 12, $ = p[19] << 20 | p[18] >>> 12, Te = p[29] << 7 | p[28] >>> 25, Ke = p[28] << 7 | p[29] >>> 25, ie = p[38] << 8 | p[39] >>> 24, mt = p[39] << 8 | p[38] >>> 24, G = p[48] << 14 | p[49] >>> 18, st = p[49] << 14 | p[48] >>> 18, p[0] = at ^ ~H & q, p[1] = z ^ ~it & j, p[10] = K ^ ~pt & Q, p[11] = Z ^ ~$ & yt, p[20] = ee ^ ~te & lt, p[21] = ot ^ ~ne & ae, p[30] = dt ^ ~ye & ue, p[31] = pe ^ ~ct & oe, p[40] = de ^ ~bt & Te, p[41] = ce ^ ~fe & Ke, p[2] = H ^ ~q & rt, p[3] = it ^ ~j & W, p[12] = pt ^ ~Q & J, p[13] = $ ^ ~yt & X, p[22] = te ^ ~lt & ie, p[23] = ne ^ ~ae & mt, p[32] = ye ^ ~ue & ft, p[33] = ct ^ ~oe & le, p[42] = bt ^ ~Te & Ze, p[43] = fe ^ ~Ke & $e, p[4] = q ^ ~rt & G, p[5] = j ^ ~W & st, p[14] = Q ^ ~J & ut, p[15] = yt ^ ~X & Y, p[24] = lt ^ ~ie & re, p[25] = ae ^ ~mt & se, p[34] = ue ^ ~ft & me, p[35] = oe ^ ~le & Tt, p[44] = Te ^ ~Ze & Qe, p[45] = Ke ^ ~$e & Je, p[6] = rt ^ ~G & at, p[7] = W ^ ~st & z, p[16] = J ^ ~ut & K, p[17] = X ^ ~Y & Z, p[26] = ie ^ ~re & ee, p[27] = mt ^ ~se & ot, p[36] = ft ^ ~me & dt, p[37] = le ^ ~Tt & pe, p[46] = Ze ^ ~Qe & de, p[47] = $e ^ ~Je & ce, p[8] = G ^ ~at & H, p[9] = st ^ ~z & it, p[18] = ut ^ ~K & pt, p[19] = Y ^ ~Z & $, p[28] = re ^ ~ee & te, p[29] = se ^ ~ot & ne, p[38] = me ^ ~dt & ye, p[39] = Tt ^ ~pe & ct, p[48] = Qe ^ ~de & bt, p[49] = Je ^ ~ce & fe, p[0] ^= zt[w], p[1] ^= zt[w + 1];
    };
    if (_)
      r.exports = n;
    else
...
var Wa = ia.exports;
const Ga = /* @__PURE__ */ Qn(Wa);
function Yt(r) {
  return "0x" + Ga.keccak_256(Ce(r));
}
const Ka = "address/5.7.0", Rt = new O(Ka);
function Vn(r) {
  De(r, 20) || Rt.throwArgumentError("invalid address", "address", r), r = r.toLowerCase();
...
const zn = Math.floor($a(Za));
function Qa(r) {
  r = r.toUpperCase(), r = r.substring(4) + r.substring(0, 2) + "00";
  let e = r.split("").map((a) => En[a]).join("");
  for (; e.length >= zn; ) {
    let a = e.substring(0, zn);
...
function vn(r) {
  let e = null;
  if (typeof r != "string" && Rt.throwArgumentError("invalid address", "address", r), r.match(/^(0x)?[0-9a-fA-F]{40}$/))
    r.substring(0, 2) !== "0x" && (r = "0x" + r), e = Vn(r), r.match(/([A-F].*[a-f])|([a-f].*[A-F])/) && e !== r && Rt.throwArgumentError("bad address checksum", "address", r);
  else if (r.match(/^XE[0-9]{2}[0-9A-Za-z]{30,31}$/)) {
    for (r.substring(2, 4) !== Qa(r) && Rt.throwArgumentError("bad icap checksum", "address", r), e = Pa(r.substring(4)); e.length < 40; )
      e = "0" + e;
    e = Vn("0x" + e);
  } else
    Rt.throwArgumentError("invalid address", "address", r);
  return e;
}
class Ja extends Ge {
  constructor(e) {
  ...
  decode(e) {
    return vn(Xn(e.readValue().toHexString(), 20));
  }
}
class Xa extends Ge {
  constructor(e) {
...
function ra(r, e, t) {
  ...
  if (Array.isArray(t))
    ...
    a = e.map((E) => {
      ...
      return N || vt.throwError("cannot encode object for signature with missing names", O.errors.INVALID_ARGUMENT, {
        ...
        coder: E,
        value: t
      }), I[N] && vt.throwError("cannot encode object for signature with duplicate names", O.errors.INVALID_ARGUMENT, {
        argument: "values",
        coder: E,
        value: t
      }), I[N] = !0, t[N];
  ...
  e.length !== a.length && vt.throwArgumentError("types/value length mismatch", "tuple", t);
  let c = new kn(r.wordSize), y = new kn(r.wordSize), T = [];
  e.forEach((I, E) => {
    let N = a[E];
    if (I.dynamic) {
      let B = y.length;
      I.encode(y, N);
      let L = c.writeUpdatableValue();
      T.push((ke) => {
        L(ke + B);
      });
    } else
...
function sa(r, e) {
  ...
  e.forEach((y) => {
    let T = null;
    if (y.dynamic) {
      let _ = r.readValue(), I = a.subReader(_.toNumber());
      try {
        T = y.decode(I);
      } catch (E) {
  ...
  const c = e.reduce((y, T) => {
    const _ = T.localName;
    return _ && (y[_] || (y[_] = 0), y[_]++), y;
  }, {});
  e.forEach((y, T) => {
    let _ = y.localName;
    if (!_ || c[_] !== 1 || (_ === "length" && (_ = "_length"), t[_] != null))
      return;
    const I = t[T];
    I instanceof Error ? Object.defineProperty(t, _, {
      enumerable: !0,
      get: () => {
        throw I;
      }
...
class Ya extends Ge {
  constructor(e, t, a) {
    const c = e.type + "[" + (t >= 0 ? t : "") + "]", y = t === -1 || e.dynamic;
    super("array", c, a, y), this.coder = e, this.length = t;
  }
  defaultValue() {
  ...
  encode(e, t) {
    ...
    let a = this.length;
    a === -1 && (a = t.length, e.writeValue(t.length)), vt.checkArgumentCount(t.length, a, "coder array" + (this.localName ? " " + this.localName : ""));
    let c = [];
    for (let y = 0; y < t.length; y++)
      c.push(this.coder);
    return ra(e, c, t);
  ...
  decode(e) {
    ...
    let a = [];
    for (let c = 0; c < t; c++)
      a.push(new Xa(this.coder));
    return e.coerce(this.name, sa(e, a));
  }
}
class ei extends Ge {
  constructor(e) {
...
const ii = /* @__PURE__ */ be.from(-1), ri = /* @__PURE__ */ be.from(0), si = /* @__PURE__ */ be.from(1), pi = /* @__PURE__ */ be.from("0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
class yi extends Ge {
  constructor(e, t, a) {
    const c = (t ? "int" : "uint") + e * 8;
    super(c, c, a, !1), this.size = e, this.signed = t;
  }
  defaultValue() {
    return 0;
  }
  encode(e, t) {
    let a = be.from(t), c = pi.mask(e.wordSize * 8);
    if (this.signed) {
      let y = c.mask(this.size * 8 - 1);
      (a.gt(y) || a.lt(y.add(si).mul(ii))) && this._throwError("value out-of-bounds", t);
    } else
      (a.lt(ri) || a.gt(c.mask(this.size * 8))) && this._throwError("value out-of-bounds", t);
...
const ui = "strings/5.7.0", ya = new O(ui);
var en;
(function(r) {
...
function oi(r, e, t, a, c) {
  return ya.throwArgumentError(`invalid codepoint at offset ${e}; ${r}`, "bytes", t);
}
function ua(r, e, t, a, c) {
...
function li(r, e, t, a, c) {
  return r === Oe.OVERLONG ? (a.push(c), 0) : (a.push(65533), ua(r, e, t));
}
...
function di(r, e) {
  ...
  for (; a < r.length; ) {
    ...
    if ((c & 224) === 192)
      ...
      (c & 192) === 128 ? a += e(Oe.UNEXPECTED_CONTINUE, a - 1, r, t) : a += e(Oe.BAD_PREFIX, a - 1, r, t);
      continue;
    }
    if (a - 1 + y >= r.length) {
...
function oa(r, e = en.current) {
  e != en.current && (ya.checkNormalize(), r = r.normalize(e));
  let t = [];
  for (let a = 0; a < r.length; a++) {
    ...
    if (c < 128)
      ...
      const T = 65536 + ((c & 1023) << 10) + (y & 1023);
...
class Wt extends Ge {
  constructor(e, t) {
    ...
    const c = [];
    e.forEach((T) => {
      T.dynamic && (a = !0), c.push(T.type);
    });
    const y = "tuple(" + c.join(",") + ")";
  ...
  defaultValue() {
    ...
    const t = this.coders.reduce((a, c) => {
      const y = c.localName;
      return y && (a[y] || (a[y] = 0), a[y]++), a;
    }, {});
    return this.coders.forEach((a, c) => {
      let y = a.localName;
      !y || t[y] !== 1 || (y === "length" && (y = "_length"), e[y] == null && (e[y] = e[c]));
    }), Object.freeze(e);
  }
  encode(e, t) {
    return ra(e, this.coders, t);
  }
  decode(e) {
    return e.coerce(this.name, sa(e, this.coders));
  }
}
const Gt = new O(Vt), bi = new RegExp(/^bytes([0-9]*)$/), hi = new RegExp(/^(u?int)([0-9]*)$/);
class gi {
  constructor(e) {
  ...
  _getCoder(e) {
    switch (e.baseType) {
      case "address":
        return new Ja(e.name);
      case "bool":
        return new ei(e.name);
      case "string":
        return new Ti(e.name);
      case "bytes":
        return new ti(e.name);
      case "array":
        return new Ya(this._getCoder(e.arrayChildren), e.arrayLength, e.name);
      case "tuple":
        return new Wt((e.components || []).map((a) => this._getCoder(a)), e.name);
      case "":
        return new ai(e.name);
    }
    let t = e.type.match(hi);
    if (t) {
      let a = parseInt(t[2] || "256");
      return (a === 0 || a > 256 || a % 8 !== 0) && Gt.throwArgumentError("invalid " + t[1] + " bit length", "param", e), new yi(a / 8, t[1] === "int", e.name);
    }
    if (t = e.type.match(bi), t) {
      let a = parseInt(t[1]);
      return (a === 0 || a > 32) && Gt.throwArgumentError("invalid bytes length", "param", e), new ni(a, e.name);
    }
    return Gt.throwArgumentError("invalid type", "type", e.type);
  }
  _getWordSize() {
    return 32;
  }
  _getReader(e, t) {
    return new Xt(e, this._getWordSize(), this.coerceFunc, t);
  }
  _getWriter() {
    return new kn(this._getWordSize());
  }
  getDefaultValue(e) {
    const t = e.map((c) => this._getCoder(ve.from(c)));
    return new Wt(t, "_").defaultValue();
  }
  encode(e, t) {
    e.length !== t.length && Gt.throwError("types/values length mismatch", O.errors.INVALID_ARGUMENT, {
      count: { types: e.length, values: t.length },
      value: { types: e, values: t }
    });
    const a = e.map((T) => this._getCoder(ve.from(T))), c = new Wt(a, "_"), y = this._getWriter();
    return c.encode(y, t), y.data;
  }
  decode(e, t, a) {
    const c = e.map((T) => this._getCoder(ve.from(T)));
    return new Wt(c, "_").decode(this._getReader(Ce(t), a));
  }
}
const Mi = new gi();
function Kt(r) {
...
class xi {
  constructor(e) {
    let t = [];
    typeof e == "string" ? t = JSON.parse(e) : t = e, Ie(this, "fragments", t.map((a) => je.from(a)).filter((a) => a != null)), Ie(this, "_abiCoder", qt(new.target, "getAbiCoder")()), Ie(this, "functions", {}), Ie(this, "errors", {}), Ie(this, "events", {}), Ie(this, "structs", {}), this.fragments.forEach((a) => {
      let c = null;
      switch (a.type) {
        case "constructor":
          if (this.deploy) {
      ...
      c[y] = a;
    }), this.deploy || Ie(this, "deploy", Le.from({
      payable: !1,
      type: "constructor"
  ...
  getFunction(e) {
    ...
    if (e.indexOf("(") === -1) {
      const a = e.trim(), c = Object.keys(this.functions).filter((y) => y.split(
        "("
        /* fix:) */
      )[0] === a);
      return c.length === 0 ? Me.throwArgumentError("no matching function", "name", a) : c.length > 1 && Me.throwArgumentError("multiple matching functions", "name", a), this.functions[c[0]];
    }
  ...
  getEvent(e) {
    ...
    if (e.indexOf("(") === -1) {
      const a = e.trim(), c = Object.keys(this.events).filter((y) => y.split(
        "("
        /* fix:) */
      )[0] === a);
      return c.length === 0 ? Me.throwArgumentError("no matching event", "name", a) : c.length > 1 && Me.throwArgumentError("multiple matching events", "name", a), this.events[c[0]];
    }
  ...
  getError(e) {
    if (De(e)) {
      const a = qt(this.constructor, "getSighash");
      for (const c in this.errors) {
        const y = this.errors[c];
        if (e === a(y))
    ...
    if (e.indexOf("(") === -1) {
      const a = e.trim(), c = Object.keys(this.errors).filter((y) => y.split(
        "("
        /* fix:) */
      )[0] === a);
      return c.length === 0 ? Me.throwArgumentError("no matching error", "name", a) : c.length > 1 && Me.throwArgumentError("multiple matching errors", "name", a), this.errors[c[0]];
    }
  ...
  getSighash(e) {
    ...
    return qt(this.constructor, "getSighash")(e);
  }
  // Get the topic (the bytes32 hash) used by Solidity to identify an event
  getEventTopic(e) {
    return typeof e == "string" && (e = this.getEvent(e)), qt(this.constructor, "getEventTopic")(e);
  }
  _decodeParams(e, t) {
  ...
  encodeErrorResult(e, t) {
    return typeof e == "string" && (e = this.getError(e)), _e(xt([
      this.getSighash(e),
  ...
  encodeFunctionData(e, t) {
    return typeof e == "string" && (e = this.getFunction(e)), _e(xt([
      this.getSighash(e),
      this._encodeParams(e.inputs, t || [])
    ]));
  }
  ...
  decodeFunctionResult(e, t) {
    typeof e == "string" && (e = this.getFunction(e));
    let a = Ce(t), c = null, y = "", T = null, _ = null, I = null;
    switch (a.length % this._abiCoder._getWordSize()) {
      case 0:
        ...
        break;
      case 4: {
        const E = _e(a.slice(0, 4)), N = vi[E];
        if (N)
          T = this._abiCoder.decode(N.inputs, a.slice(4)), _ = N.name, I = N.signature, N.reason && (c = T[0]), _ === "Error" ? y = `; VM Exception while processing transaction: reverted with reason string ${JSON.stringify(T[0])}` : _ === "Panic" && (y = `; VM Exception while processing transaction: reverted with panic code ${T[0]}`);
        else
          try {
            const B = this.getError(E);
            T = this._abiCoder.decode(B.inputs, a.slice(4)), _ = B.name, I = B.format();
          } catch {
          }
        break;
      }
  ...
  encodeFilterTopics(e, t) {
    ...
    const c = (y, T) => y.type === "string" ? Kt(T) : y.type === "bytes" ? Yt(_e(T)) : (y.type === "bool" && typeof T == "boolean" && (T = T ? "0x01" : "0x00"), y.type.match(/^u?int/) && (T = be.from(T).toHexString()), y.type === "address" && this._abiCoder.encode(["address"], [T]), Xn(_e(T), 32));
    for (t.forEach((y, T) => {
      let _ = e.inputs[T];
      if (!_.indexed) {
      ...
      y == null ? a.push(null) : _.baseType === "array" || _.baseType === "tuple" ? Me.throwArgumentError("filtering with tuples or arrays not supported", "contract." + _.name, y) : Array.isArray(y) ? a.push(y.map((I) => c(_, I))) : a.push(c(_, y));
    ...
    return e.anonymous || a.push(this.getEventTopic(e)), t.length !== e.inputs.length && Me.throwArgumentError("event arguments/values mismatch", "values", t), e.inputs.forEach((T, _) => {
      ...
      if (T.indexed)
        if (T.type === "string")
          ...
          a.push(this._abiCoder.encode([T.type], [I]));
        }
      else
        c.push(T), y.push(I);
    }), {
      data: this._abiCoder.encode(c, y),
      topics: a
    };
  }
  ...
  decodeEventLog(e, t, a) {
    ...
    e.inputs.forEach((L, ke) => {
      L.indexed ? L.type === "string" || L.type === "bytes" || L.baseType === "tuple" || L.baseType === "array" ? (c.push(ve.fromObject({ type: "bytes32", name: L.name })), T.push(!0)) : (c.push(L), T.push(!1)) : (y.push(L), T.push(!1));
    });
    let _ = a != null ? this._abiCoder.decode(c, xt(a)) : null, I = this._abiCoder.decode(y, t, !0), E = [], N = 0, B = 0;
    e.inputs.forEach((L, ke) => {
      if (L.indexed)
        if (_ == null)
          E[ke] = new Hn({ _isIndexed: !0, hash: null });
        else if (T[ke])
          E[ke] = new Hn({ _isIndexed: !0, hash: _[B++] });
        else
          try {
            E[ke] = _[B++];
          } catch (we) {
      ...
      if (L.name && E[L.name] == null) {
        ...
        we instanceof Error ? Object.defineProperty(E, L.name, {
          enumerable: !0,
          get: () => {
            throw qn(`property ${JSON.stringify(L.name)}`, we);
          }
        }) : E[L.name] = we;
      }
    });
  ...
  parseLog(e) {
    ...
    return !t || t.anonymous ? null : new wi({
      eventFragment: t,
      name: t.name,
      signature: t.format(),
...
new xi(Ii);
const jn = (r) => Number.isSafeInteger(r) && r > 0 && r <= ka.MAX_SAFE_CHAIN_ID, Ai = (r) => {
  if (typeof r == "number")
    return { valid: jn(r), chainId: r };
  if (typeof r == "string")
    try {
      let e;
...
const Wn = (r) => {
  if (!r)
    return "1";
  const { chainId: e, valid: t } = Ai(r);
  return t ? `${e}` : "1";
}, Gn = () => {
  var t;
  const r = window, e = (t = r.foxwallet) == null ? void 0 : t.ethereum;
  if (e instanceof It)
    return e;
  if (r.ethereum instanceof It)
    return r.ethereum;
};
class It extends Zn {
  constructor() {
    super();
    Ee(this, "chain", Dt.ETH);
  ...
  request(t) {
    ...
    let a = this;
    if (this instanceof It || (a = Gn()), !a)
      throw new Zt(4900, "FoxWallet provider is not available.");
    return a._request(t);
  }
  _wrapResult(t, a) {
    let c = { jsonrpc: "2.0", id: t.id };
    return a !== null && typeof a == "object" && a.jsonrpc && a.result ? c.result = a.result : c.result = a, c;
  }
  async _request(t) {
    switch (t.method) {
  ...
  sendAsync(t, a) {
    ...
    let c = this;
    if (this instanceof It || (c = Gn()), !c) {
      a(new Zt(4900, "FoxWallet provider is not available."));
      return;
    }
    Array.isArray(t) ? Promise.all(
      t.map(
        (y) => c._request(y).then((T) => a(null, c._wrapResult(y, T))).catch((T) => a(T, null))
      )
    ) : c._request(t).then((y) => a(null, c._wrapResult(t, y))).catch((y) => a(y, null));
  }
  ...
  emit(t, a) {
    switch (super.emit(t, a), console.log("eth emit", t, a), t) {
      case "chainChanged":
        typeof a == "string" && a && (this._chainId = a, this._setGlobalChainId(a).catch((c) => {
          console.log("_setGlobalChainId", c);
        }));
        break;
      case "networkChanged":
        break;
  ...
  onDappEmit(t) {
    const { detail: a } = t, { type: c, coinType: y, event: T, data: _ } = a;
    y === Dt.ETH && this.emit(T, _);
  }
}
const Kn = {
...
}, la = new _a(), tn = new It(), Ye = window, Ei = (r, e) => {
  let t = r;
  for (; t; ) {
  ...
  var r;
  try {
    const e = Ei(Ye, "ethereum");
    if (e && "value" in e && e.value || e != null && e.get && e.get.call(Ye) || e && !e.writable && !e.set)
      return;
    if (!e || e.writable) {
      Ye.ethereum = tn;
      return;
    }
    (r = e.set) == null || r.call(Ye, tn);
  } catch {
  }
};
Ye.foxwallet = {
...
const Ci = {
  ...
  icon: Kn.SVG_ICON,
  rdns: "com.foxwallet"
}, Oi = Object.freeze({ info: Ci, provider: tn });
function ma() {
